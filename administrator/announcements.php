        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="<?= htmlspecialchars($user["ad_picture"]) ?>" alt="profile"/>
            </a>
          ...
          <li class="nav-item nav-profile">
            <div class="nav-link">
              ...
              <div class="profile-name">
                ...
                <p class="designation">
                <?= htmlspecialchars($user["ad_Position"]) ?>
                </p>
              </div>
            </div>
          </li>
          ...
          <li class="nav-item d-none d-lg-block">
            ...
            <div class="collapse" id="sidebar-layouts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="reports.html">Problem Reports</a></li>
                <li class="nav-item"> <a class="nav-link" href="songrequests.html">Songs Requests</a></li>
                <li class="nav-item"> <a class="nav-link" href="homeprayerrequests.html">Home Prayer Request</a></li>
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/widgets.html">
              ...
              <span class="menu-title">Church Commitee</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/widgets.html">
              <i class="fa fa-phone-square menu-icon"></i>
              <span class="menu-title">Church information</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/widgets.html">
              <i class="fa fa-check-square menu-icon"></i>
              <span class="menu-title">Church Gallery</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/widgets.html">
